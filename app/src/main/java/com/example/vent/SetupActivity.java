...
public class SetupActivity extends AppCompatActivity {
    ...
    // Two-factor authentication: saving country name, display name and status in database
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //selects a country in the spinner
    ...
    //displays all the countries in a spinner (a spinner is basically a drop-down menu)
    ...
    private void SaveAccountSetupInformation() {
        ...
        //checks if the required info is filled
        if(TextUtils.isEmpty(displayname)){
            ...
            //default user status if none is provided
            if(userStatus.isEmpty()){
                userStatus = "Hello! I'm using TherapyApp";
            }

            //save all the user info in the database
